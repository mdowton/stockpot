                ...
                <li>
                    <ul class="row-fluid">
                        <li class="span4"><a href="work1.html"><img
                                src="$ThemeDir/images/content/works/thumbnails/work-thumbnail-1.jpg" alt=""></a></li>
                        <li class="span4"><a href="work2.html"><img
                                src="$ThemeDir/images/content/works/thumbnails/work-thumbnail-2.jpg" alt=""></a></li>
                        <li class="span4"><a href="work3.html"><img
                                src="$ThemeDir/images/content/works/thumbnails/work-thumbnail-3.jpg" alt=""></a></li>
                    </ul>
                    <ul class="row-fluid">
                        <li class="span4"><a href="work4.html"><img
                                src="$ThemeDir/images/content/works/thumbnails/work-thumbnail-4.jpg" alt=""></a></li>
                        <li class="span4"><a href="work5.html"><img
                                src="$ThemeDir/images/content/works/thumbnails/work-thumbnail-5.jpg" alt=""></a></li>
                        <li class="span4"><a href="work6.html"><img
                                src="$ThemeDir/images/content/works/thumbnails/work-thumbnail-6.jpg" alt=""></a></li>
                    </ul>
                </li>
                <li>
                    <ul class="row-fluid">
        ...
        <div class="container">
            ...
            <div class="row-fluid">
                <div class="span4 icon-box">
                    <h4><i class="icon-cogs"></i>HTML5 & CSS3</h4>
                ...
                <div class="span4 icon-box">
                    <h4><i class="icon-thumbs-up"></i>Easy to use</h4>
...
<section id="Info" class="parallax" style="background-image: url('$ThemeDir/images/content/background-image-2.jpg')">
    <div class="container">
        ...
        <div class="row-fluid">
            <div class="span12">
                <p class="huge">
                    Pellentesque id nunc tempus metus gravida luctus id sit amet ipsum. Fusce eleifend ipsum vel odio
                    hendrerit eu auctor nibh dictum. Vivamus facilisis blandit ante id ultricies. Suspendisse id metus
                    elit. Nullam odio leo, ornare ac porta et, suscipit non lectus.
                </p>
            </div>
        </div>
    </div>
    ...
    <section id="Clients">
        <div class="container">
            ...
            <ul class="row-fluid">
                <li class="span3"><img src="$ThemeDir/images/content/clients/client-1.png" alt="client1"></li>
                <li class="span3"><img src="$ThemeDir/images/content/clients/client-2.png" alt="client2"></li>
                <li class="span3"><img src="$ThemeDir/images/content/clients/client-3.png" alt="client3"></li>
                <li class="span3"><img src="$ThemeDir/images/content/clients/client-4.png" alt="client4"></li>
            </ul>
            <ul class="row-fluid">
